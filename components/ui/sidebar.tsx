    ...
    if (isMobile) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetTitle className="sr-only">Menu thanh bên</SheetTitle>
          <SheetDescription className="sr-only">
            Mobile menu thanh bên
          </SheetDescription>
          <SheetContent
...
>(({ onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">Đóng/mở menu thanh bên</span>
    </Button>
  );
});
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      data-sidebar="rail"
      aria-label="Đóng/mở menu thanh bên"
      tabIndex={-1}
