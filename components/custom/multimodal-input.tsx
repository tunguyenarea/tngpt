...
const suggestedActions = [
  {
    title: 'Thời tiết ở Hà Nội',
    label: 'thế nào?',
    action: 'Thời tiết ở Hà Nội thế nào?',
  },
  {
    title: "Tại sao nước biển",
    label: 'lại có màu xanh?',
    action: "Tại sao nước biển lại có màu xanh?",
  },
];
      ...
      <Textarea
        ...
        onKeyDown={(event) => {
          if (event.key === 'Enter' && !event.shiftKey) {
            ...
            if (isLoading) {
              toast.error('Vui lòng đợi model hoàn tất phản hồi!');
            } else {
              submitForm();
            }
          }
